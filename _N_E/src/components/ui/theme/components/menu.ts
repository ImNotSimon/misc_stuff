...
const menuItem = tv({
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      class: {
        base: [
          'data-[hover=true]:bg-accent data-[hover=true]:text-secondary-foreground',
    ...
    // shadow / color
    {
      ...
      class: {
        base: [
          'data-[hover=true]:shadow-primary/50 data-[hover=true]:bg-primary data-[hover=true]:text-primary-foreground',
          'data-[selectable=true]:focus:shadow-primary/50 data-[selectable=true]:focus:bg-primary data-[selectable=true]:focus:text-primary-foreground',
        ],
      },
    },
    {
